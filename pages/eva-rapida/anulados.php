		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Evaluaciones Rápidas - Anulados</h1>
					<div class="row">
						<div class="col-12">
							<div class="card flex-fill" id="evaluaciones-rapidas-table" data-estado="Anulado">
								<div class="card-header">
									<h5 class="card-title mb-0">Anulados</h5>
								</div>
