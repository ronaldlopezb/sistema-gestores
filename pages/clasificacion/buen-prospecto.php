...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Lead clasificada como: Buen Prospecto</h1>
					<div class="row">
						<div class="col-12">
							<div class="card flex-fill" id="recien-llegados-table">
								<div class="card-header">
								<h5 class="card-title mb-0">Lead clasificada como: Buen Prospecto</h5>
								</div>
	...
	<script src="<?php echo $baseUrl; ?>/js/buen-prospecto.js"></script>
</body>
