		...
		<ul class="navbar-nav navbar-align">
			...
			<li class="nav-item dropdown">
				...
				<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
					<img id="user-avatar" src="<?php echo $baseUrl; ?>/assets/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Usuario" />
					<span class="text-dark" id="user-name">Usuario</span>
				</a>
				<div class="dropdown-menu dropdown-menu-end">
					<a class="dropdown-item" href="<?php echo $baseUrl; ?>/pages/user/perfil.php"><i class="align-middle me-1" data-feather="user"></i> Perfil</a>
					<a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="help-circle"></i> Ayuda</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="#" id="logout-button">Cerrar sesion</a>
				</div>
			</li>
		</ul>
	</div>
